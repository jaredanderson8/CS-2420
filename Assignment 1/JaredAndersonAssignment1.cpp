...
public:
  ...
  T top();
  void popThirdFromTop();
  void pushTwoUnderTop(const T& t);
  T topThirdFromTop();
...
template <typename T>
void StackForCS2420<T>::push(const T& t)
{
    if(index_ >= capacity_)
    {
    ...
    {
        arr[index_] = t;
        //cout << "pushed " << t << " at index of " << index_ << endl;
        index_++;
    } 
}
...
{
    //cout << "Popped " << top() << " From the top of the stack." << endl;
    if(index_ < 1)
    {
        //cout << "Error: Cannot pop the stack as the stack is empty," << endl;
    }
    else
    {
        index_--;
...
T StackForCS2420<T>::top()
{
    if(index_ == 0)
    {
        //cout << "Error: cannot return top because the stack is empty." << endl;
        throw 1;
    }
    else
    {
...
void StackForCS2420<T>::popThirdFromTop()
{
    if(index_ - 2 < 0)
    {
        //cout << "Error: cannot pop third from top as it does not exist." << endl;
    }
    else
    {
        //cout << "Popped " << arr[index_ - 3] << " From the third below the top of the stack." << endl;
        arr[index_ - 3] = arr[index_ - 2];
        arr[index_ - 2] = arr[index_ - 1];
        index_--;
    }
...
template <typename T>
void StackForCS2420<T>::pushTwoUnderTop(const T& t)
{
    if(index_ >= capacity_)
    {
        //cout << "Error: stack is full" << endl;
...
T StackForCS2420<T>::topThirdFromTop()
{
    if(index_ - 2 < 0)
    {
        //cout << "Error: cannot retrive the value third from top as it does not exist." << endl;
        //throw 1;
    }
    else
    {
